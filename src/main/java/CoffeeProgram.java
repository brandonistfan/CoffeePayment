...
public class CoffeeProgram {
    public static void main(String[] args) {
        ...
        System.out.println("Do you want to remove a customer permanently? (Yes/No)");
        if (scanner.nextLine().equalsIgnoreCase("Yes")) {
    ...
    public static void removeCustomer(List<Customer> customers, Scanner scanner) {
        System.out.println("Enter the name of the customer to be removed:");
        String name = scanner.nextLine();

        boolean foundAndRemoved = customers.removeIf(customer -> customer.getName().equalsIgnoreCase(name));
